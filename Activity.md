...
5. If the amount of servings left is lower than 15, decrease portion sizes or restock that food item
6. If the amount of servings left is higher than 15, there is no need to lower portion sizes or restock that food item
